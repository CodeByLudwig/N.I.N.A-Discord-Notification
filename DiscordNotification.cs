using DanielLudwig.NINA.DiscordNotification.Properties;
...
namespace DanielLudwig.NINA.DiscordNotification {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "DiscordNotification_Options" where DiscordNotification corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    ...
    public class DiscordNotification : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "Discord Notification");
