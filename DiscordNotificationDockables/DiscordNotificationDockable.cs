...
namespace DanielLudwig.NINA.DiscordNotification.DiscordNotificationDockables {
    /// <summary>
    ...
    public class DiscordNotificationDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public DiscordNotificationDockable(
            ...
            dict.Source = new Uri("DanielLudwig.NINA.DiscordNotification;component/DiscordNotificationDockables/DiscordNotificationDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["DanielLudwig.NINA.DiscordNotification_AltitudeSVG"];
