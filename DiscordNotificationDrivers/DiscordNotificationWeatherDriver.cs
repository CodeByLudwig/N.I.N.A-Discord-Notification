...
namespace DanielLudwig.NINA.DiscordNotification.DiscordNotificationDrivers {
    ...
    /// </summary>
    public class DiscordNotificationWeatherDriver : BaseINPC, IWeatherData {
        public DiscordNotificationWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"DiscordNotification Weather Data ({deviceId})";
        ...
        public string Category => "DiscordNotification Weather Driver";
