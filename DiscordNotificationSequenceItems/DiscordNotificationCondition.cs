...
namespace DanielLudwig.NINA.DiscordNotification.DiscordNotificationTestCategory {
    ...
    public class DiscordNotificationCondition : SequenceCondition {
        /// <summary>
        ...
        public DiscordNotificationCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new DiscordNotificationCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(DiscordNotificationCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}