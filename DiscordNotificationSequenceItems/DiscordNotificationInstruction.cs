...
namespace DanielLudwig.NINA.DiscordNotification.DiscordNotificationTestCategory {
    /// <summary>
    ...
    public class DiscordNotificationInstruction : SequenceItem {
        /// <summary>
        ...
        public DiscordNotificationInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public DiscordNotificationInstruction(DiscordNotificationInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new DiscordNotificationInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(DiscordNotificationInstruction)}, Text: {Text}";
        }
    }
}