...
namespace DanielLudwig.NINA.DiscordNotification.DiscordNotificationTestCategory {
    ...
    public class DiscordNotificationTrigger : SequenceTrigger {
        /// <summary>
        ...
        public DiscordNotificationTrigger() {
        }

        public override object Clone() {
            return new DiscordNotificationTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(DiscordNotificationTrigger)}";
        }
    }
}